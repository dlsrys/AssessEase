 ...
 <body>
    ...
    <div class="container1">
        <div class="d-flex justify-content-center align-items-center">
            ...
            <div class="row mt-2">
                <div class="col-md-6"><label class="labels">First Name</label><input type="text" name="fname" class="form-control" value="<?php echo$user['firstname']; ?>" required></div>
                <div class="col-md-6"><label class="labels">Last Name</label><input type="text" name="lname" class="form-control" value="<?php echo$user['lastname']; ?>" required></div>
            </div>
            ...
            <div class="col-md-12"><label class="labels">Email Address</label><input class="form-control" name="email" type="text" value="<?php echo$user['email']; ?>" aria-label="Disabled input example" disabled readonly></div>
                <div class="col-md-12"><label class="labels">School</label><input type="text" class="form-control" name="school" value="<?php echo$user['school']; ?>" required></div>
